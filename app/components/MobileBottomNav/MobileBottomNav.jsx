...
export default function MobileBottomNav() {
  ...
  const exploreActive =
    pathname === "/" && (Boolean(searchParams.get("region")) || hash === "#destinations");
  const aboutActive = pathname === "/about-us";
  const homeActive = pathname === "/" && !exploreActive && !aboutActive;

  return (
    <nav className="mobileBottomNav" aria-label="Mobile navigation">
      <Link href="/" className={homeActive ? "navActive" : ""}>
      ...
      <Link href="/#destinations" className={exploreActive ? "navActive" : ""}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link href="/about-us" className={aboutActive ? "navActive" : ""}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="8" r="4" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M6 21v-1a6 6 0 0112 0v1" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        About
      </Link>
